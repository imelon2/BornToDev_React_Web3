...
const ConnectButton = (props) => {
  const { isConnected, connectWallet, currentBalance, walletAddress, chainId, addToken } =
    props;
    ...
    <>
      {isConnected ? (
        <div className="buttonContainer">
            <span className="pageButtonBold connectButton" style={{cursor: "pointer"}} onClick={() => addToken()}>ADD TOKEN</span>
